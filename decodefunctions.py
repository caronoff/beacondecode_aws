...
x=hextobin('001197E74F216C038A4C89D0000000000017FFF003FFFFFFE70EB3BB0E83DD0')
...
w=bin2hex('001000000001000110010111111001110100111100100001011011000000001110001010010011001000100111010000000000000000000000000000000000000000000000010111111111111111000000000011111111111111111111111111111001110000111010110011101110110000111010000011110111010000')
print(x)
print(len(x))
